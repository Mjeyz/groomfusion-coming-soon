// ------------------------------------------------
// Project Name: Groom Fusion - Next Level
// Project Description: Groom Fusion - Next Level
// Latest beauty products, cosmetics, beauty, makup
// Version: 1.0.0
// Build Date: May 2022
...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2023, 2, 1), format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
